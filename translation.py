...
"""
    ...
    BANNED_USER_TEXT = "Sorry!! But Owner Banned You From Using This Service. That Means You Can't Run ME Now! \n \n Contact : @Tellybots_support For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do, Mate?"
    UPGRADE_TEXT = "CONTACT : Support. @Tellybots_support"
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @tellybots_support"
...
⚡ Convert Files into Video 
 ...
 Feedback ➜ <a href="https://telegram.dog/tellybots_4u"><b>Tellybots_4u</b></a>
    """
    HELP_USER = """Use below buttons to know how to use commands
